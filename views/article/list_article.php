                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <img style="width: 100px;" src="/CSE485_2023_BTTH02/views/images/songs/<?php echo $article->getHinhanh(); ?>">
                                </td>
                                <td>
                                    <a href="index.php?controller=article&action=edit&id=<?= $article->getMa_bviet() ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                </td>
                                <td>
                                    <a onclick="return confirm('Bạn có muốn xóa không');" href="/CSE485_2023_BTTH02/index.php?controller=article&action=delete&id= <?= $article->getMa_bviet() ?>"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php
                        }
