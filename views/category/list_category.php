                        ...
                        foreach($categorys as $category){
                            $count++;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?= $category->getSLBaiViet() ?>
                                    </td>
                                    <td>
                                        <a href="index.php?controller=category&action=edit&id=<?= $category->getMa_tloai() ?>"><i class="fa-solid fa-pen-to-square"></i></a>
                                    </td>
                                    <td>
                                        <a onclick="return confirm('Ban co muon xoa khong');"
                                            href="/CSE485_2023_BTTH02/index.php?controller=category&action=delete&id= <?= $category->getMa_tloai() ?>"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
