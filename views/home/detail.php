...
<body>
    ...
    <main class="container mt-5">
        <!-- <h3 class="text-center text-uppercase mb-3 text-primary">CẢM NHẬN VỀ BÀI HÁT</h3> -->
                ...
                <div class="row mb-5">
                    <div class="col-sm-4">
                        <img src="/CSE485_2023_BTTH02/views/images/songs/<?= $article->getHinhanh()?>" class="img-fluid" alt="...">
                    </div>
                    <div class="col-sm-8">
                        <h5 class="card-title mb-2">
                            <a href="" class="text-decoration-none"><?=$article->getTieude()?></a>
                        </h5>
                        <p class="card-text"><span class=" fw-bold">Bài hát: </span><?=$article->getTen_bhat()?> </p>
                        <p class="card-text"><span class=" fw-bold">Thể loại: </span><?=$article->getTen_tloai()?></p>
                        ...
                        <p class="card-text"><span class=" fw-bold">Tác giả: </span><?=$article->getTacgia()?></p>
