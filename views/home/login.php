        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary shadow p-3 bg-white rounded">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                    <a class="nav-link active" href="<?php echo 'http://localhost:8080/CSE485_2023_BTTH02'.'/index.php?controller=home&action=login'; ?>">Đăng nhập</a>
                    </li>
                </ul>
                    ...
                    <div class="card-body">
                        <form action="index.php?controller=home&action=login" method="post">
                            ...
                            <div class="form-group">
                                <input type="submit" value="Login" name="Login" id="Login" class="btn float-end login_btn">
                            </div>
                        </form>
                    </div>
